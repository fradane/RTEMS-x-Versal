...
\item
  \textbf{Source code and report:} \hypertarget{github}{\url{https://github.com/fradane/RTEMS-x-Versal}}
...
\begin{enumerate}
  \item \textbf{Boot RTEMS on the RPU in split mode} and produce serial output,
        confirming that the RTOS is fully initialised and is
        running.
...
The complete and detailed guide is available at the project's GitHub repository~\hyperlink{github}{[1]}.
...
Both applications are available in the project repository~\hyperlink{github}{[1]}.
